                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('user.profile') }}">Profil</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    ...
                    <!-- form start -->
                    <form id="quickForm" action="{{ route('user.profile-update') }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="input" name="name" class="form-control" id="name"
                                    placeholder="Masukkan nama" value="{{ $dataUser->name }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file mt-2">
                                    ...
                                    <input type="file" class="custom-file-input" onchange="previewPhoto()"
